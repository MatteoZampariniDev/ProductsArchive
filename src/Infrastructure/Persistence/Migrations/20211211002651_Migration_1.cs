...
namespace ProductsArchive.Infrastructure.Persistence.Migrations
{
    public partial class Migration_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "LocalizedStringValues",
                columns: table => new
                {
                    LocalizedStringId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TwoLetterISOLanguageName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocalizedStringValues", x => new { x.LocalizedStringId, x.TwoLetterISOLanguageName });
                    table.ForeignKey(
                        name: "FK_LocalizedStringValues_LocalizedStrings_LocalizedStringId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSizes_LocalizedStrings_NameId",
                        column: x => x.NameId,
                        principalTable: "LocalizedStrings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductGroups_LocalizedStrings_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "LocalizedStrings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductGroups_LocalizedStrings_NameId",
                        column: x => x.NameId,
                        principalTable: "LocalizedStrings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_NameId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGroups_DescriptionId",
                table: "ProductGroups",
                column: "DescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGroups_NameId",
                table: "ProductGroups",
                column: "NameId");
