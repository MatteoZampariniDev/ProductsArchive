...
public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>, IApplicationDbContext
{
    ...
    public DbSet<LocalizedStringValue> LocalizedStringValues => Set<LocalizedStringValue>();
    public DbSet<ProductCategory> ProductCategories => Set<ProductCategory>();
    public DbSet<ProductGroup> ProductGroups => Set<ProductGroup>();
    public DbSet<Product> Products => Set<Product>();
    public DbSet<ProductSize> ProductSizes => Set<ProductSize>();

    public void SetEntityState(AuditableEntity entity, EntityState entityState)
    {
    ...
    //private bool HasUpdatedLocalizedProperties(EntityEntry entry)
    //{
    //    var localizedProperties = entry.Entity.GetLocalizedProperties();
    ...
    //    {
    //        if (ChangeTracker.Entries().Any(x => x.State == EntityState.Modified && x.Entity == prop))
    //        {
    //            return true;
    //        }
    //    }
